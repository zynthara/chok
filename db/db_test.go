...
func TestMigrate_UniqueIndexOnSoftDelete_Allowed(t *testing.T) {
	gdb := openTestDB(t)
	err := Migrate(context.Background(), gdb, Table(&BadUniqueIndex{}))
	if err != nil {
...
func TestMigrate_SoftUniqueOnNonSoftDelete_Error(t *testing.T) {
	...
	err := Migrate(context.Background(), gdb, TableSpec{
		model:   &TestItem{},
...
func TestMigrate_SoftUniqueNullablePointer_Error(t *testing.T) {
	gdb := openTestDB(t)
	err := Migrate(context.Background(), gdb, Table(&NullableColumn{}, SoftUnique("uk_email", "email")))
	if err == nil {
...
func TestBeforeCreate_SetsVersionAndRID(t *testing.T) {
	gdb := openTestDB(t)
	Migrate(context.Background(), gdb, Table(&TestUser{}, SoftUnique("uk_email", "email")))
...
func TestMigrate_IndirectSoftDelete_SoftUniqueWorks(t *testing.T) {
	gdb := openTestDB(t)
	err := Migrate(context.Background(), gdb, Table(&IndirectSoftUser{}, SoftUnique("uk_isu_email", "email")))
	if err != nil {
...
func TestOwned_MigrateWithModel(t *testing.T) {
	gdb := openTestDB(t)
	if err := Migrate(context.Background(), gdb, Table(&OwnedProduct{})); err != nil {
...
func TestOwned_MigrateWithSoftDeleteModel(t *testing.T) {
	gdb := openTestDB(t)
	if err := Migrate(context.Background(), gdb, Table(&OwnedSoftProduct{})); err != nil {
...
func TestMigrate_UniqueIndexOnAnonymousEmbedField_Allowed(t *testing.T) {
	gdb := openTestDB(t)
	err := Migrate(context.Background(), gdb, Table(&SoftUserWithEmbeddedUniqueIndex{}))
	if err != nil {
